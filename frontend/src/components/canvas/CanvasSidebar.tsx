    ...
    <>
      ...
      <div
        className={cn(
          ...
          "lg:absolute lg:bottom-3 lg:left-3 lg:top-16 lg:z-10 lg:overflow-hidden lg:rounded-xl lg:border lg:bg-surface-elevated/95 lg:shadow-elev-2 lg:backdrop-blur-xl",
          "lg:translate-x-0",
          mobileOpen
      ...
      >
        ...
        <div className="hidden border-b border-border px-4 py-3 lg:block">
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="rounded-lg border border-border bg-surface-input px-2 py-1 text-[10px] font-semibold uppercase tracking-wider text-muted">
              Builder
            </span>
          </div>
        </div>
